...
|---|---|---|
| **Entrega 1** | Definición inicial del proyecto y levantamiento de información | 🔄 En evolución |
| **Entrega 2** | Análisis y modelado del sistema | 🔄 En evolución |
| **Entrega 3** | Diseño detallado y especificación | ⏳ Pendiente |
...
## 📋 Registro de cambios por entrega

### Entrega 1
- Configuración inicial del repositorio.
- Definición inicial de VetCare.
...
La información de integrantes, roles y responsabilidades se mantendrá aquí actualizada conforme se consolide la organización del proyecto.
...
2. La **tabla de entregas parciales**.
